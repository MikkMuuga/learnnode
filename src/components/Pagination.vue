...
<template>
    <nav class="pagination is-centered" role="navigation" aria-label="pagination">
        <button @click="$emit('prev')" :disabled="!info.next" class="pagination-previous">Previous</button>
        <button @click="$emit('next')" :disabled="!info.next" Next class="pagination-next">Next page</button>
        <ul class="pagination-list">
            <li v-for="page in pageNumbers">
                ...
                aria-label="Page" aria-current="page"
                 v-else-if="page === current">{{ page }}
                </a>

                <a @click="$emit('goto', page)" 
